...
shading_square = [
    ...
    dict(pin=pin11, on=0, started=0, point=(6, 5), start_time=start_times[3], stop_time=1000, on_time=on_times[3],
         off_time=off_times[3])
    ,
    dict(pin=pin11, on=0, started=0, point=(7, 2), start_time=start_times[0], stop_time=1000, on_time=on_times[0],
         off_time=off_times[0])
    ,
    dict(pin=pin11, on=0, started=0, point=(7, 3), start_time=start_times[1], stop_time=1000, on_time=on_times[1],
         off_time=off_times[1])
    ,
    dict(pin=pin11, on=0, started=0, point=(7, 4), start_time=start_times[2], stop_time=1000, on_time=on_times[2],
         off_time=off_times[2])
    ,
...
#     ,
#     dict(pin=pin11, on=0, started=0, point=(7, 5), start_time=start_times[1], stop_time=0.1, on_time=0.003, off_time=0.003)
#     ,
